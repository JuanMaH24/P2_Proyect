...
class CrudProductosControl():
    ...
    def update_control_fertilizante(self, registro_ICA = None, nombre_producto = None, frecuencia_aplicacion = None, valor_producto = None, periodo_carencia = None):
        control_fertilizante = self.buscar_producto_control(registro_ICA)
        if control_fertilizante["Producto_control"] != None:
            control_fertilizante["Producto_control"].nombre_producto = nombre_producto
            control_fertilizante["Producto_control"].frecuencia_aplicacion = frecuencia_aplicacion
            control_fertilizante["Producto_control"].valor_producto = valor_producto
            control_fertilizante["Producto_control"].periodo_carencia = periodo_carencia

            mensaje = "Fertilizante actualizado correctamente"
            return {"Mensaje": mensaje, "Producto_Control": control_fertilizante["Producto_control"]}
        else:
